...
return {
	...
	{
		GENERIC = "Yum!",
		PAINFUL = "That didn't feel right",
		SPOILED = "Good thing I have wooden tastebuds",
		STALE = "Wilted for sure!",
		INVALID = "I'm NOT eating that",
        YUCKY = "I'm an nuts and twigs guy",
		...
		ANNOUNCE_ENCUMBERED =
		    {
		        "Huff... rustle...",
		        "Should’ve grown... sturdier roots for this...",
		        "Lift... with the stem...",
		        "This isn’t... garden work...",
		        "For... the grove... ngh!",
		        "Are my petals wilting?",
		        "Hnnngh...!",
		        "Rustle... rustle...",
		        "This is the worst... harvest...",
		    },
		    ANNOUNCE_ATRIUM_DESTABILIZING =
		    {
		        "The air feels wrong... time to sprout elsewhere!",
		        "What’s that rustling?!",
		        "This soil’s gone sour.",
		    },
		    ANNOUNCE_RUINS_RESET = "All the weeds have grown back!",
		    ANNOUNCE_SNARED = "Thorns! Tangling thorns!!",
		    ANNOUNCE_REPELLED = "It’s wrapped in bark‑thick warding!",
		    ANNOUNCE_ENTER_DARK = "The canopy’s shut out all light!",
		    ANNOUNCE_ENTER_LIGHT = "The sun’s found me again!",
		    ANNOUNCE_FREEDOM = "Free! My leaves can breathe again!",
		    ANNOUNCE_HIGHRESEARCH = "My mind’s in full bloom!",
		    ANNOUNCE_HOUNDS = "Do you hear that growl in the underbrush?",
		    ANNOUNCE_WORMS = "The ground’s writhing...",
		    ANNOUNCE_HUNGRY = "My sap’s running low...",
		    ANNOUNCE_HUNT_BEAST_NEARBY = "Fresh tracks... the creature’s close.",
		    ANNOUNCE_HUNT_LOST_TRAIL = "The trail’s gone to seed.",
		    ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "Rain’s washed the prints away.",
		    ANNOUNCE_INV_FULL = "My satchel’s overgrown!",
		    ANNOUNCE_KNOCKEDOUT = "Oof... my head’s full of dandelions...",
		    ANNOUNCE_LOWRESEARCH = "Just a seed of knowledge there.",
		    ANNOUNCE_MOSQUITOS = "Shoo! Find another flower!",
		    ANNOUNCE_NOWARDROBEONFIRE = "It’s too scorched to change!",
		    ANNOUNCE_NODANGERGIFT = "Predators are prowling—no time for gifts!",
		    ANNOUNCE_NOMOUNTEDGIFT = "I should climb down first.",
		    ANNOUNCE_NODANGERSLEEP = "Too many snapping jaws to rest.",
		    ANNOUNCE_NODAYSLEEP = "The sun’s too bright for slumber.",
		    ANNOUNCE_NODAYSLEEP_CAVE = "I’m not ready to wilt yet.",
		    ANNOUNCE_NOHUNGERSLEEP = "My belly’s too empty to settle.",
		    ANNOUNCE_NOSLEEPONFIRE = "That bed’s a bonfire!",
		    ANNOUNCE_NODANGERSIESTA = "Not safe to bask right now.",
		    ANNOUNCE_NONIGHTSIESTA = "Night is for deep roots, not naps.",
		    ANNOUNCE_NONIGHTSIESTA_CAVE = "Too damp and dim to relax here.",
		    ANNOUNCE_NOHUNGERSIESTA = "I need a snack before I can bask.",
		    ANNOUNCE_NODANGERAFK = "Can’t turn tail now!",
		    ANNOUNCE_NO_TRAP = "That was a breeze.",
		    ANNOUNCE_PECKED = "Ow! Mind the petals!",
		    ANNOUNCE_QUAKE = "The earth’s groaning...",
		    ANNOUNCE_RESEARCH = "Another ring in my tree of knowledge!",
		    ANNOUNCE_SHELTER = "Thank you, friend tree.",
		    ANNOUNCE_THORNS = "Ouch! Thorny!",
		    ANNOUNCE_BURNT = "Too much sun!",
		    ANNOUNCE_TORCH_OUT = "My light’s gone out like a wilted bloom.",
		    ANNOUNCE_THURIBLE_OUT = "The scent’s all spent.",
		    ANNOUNCE_FAN_OUT = "The breeze has left me.",
		    ANNOUNCE_COMPASS_OUT = "The needle’s lost its way.",
		    ANNOUNCE_TRAP_WENT_OFF = "Whoops—stepped on it.",
		    ANNOUNCE_UNIMPLEMENTED = "Ow! That branch isn’t ready to climb.",
		    ANNOUNCE_WORMHOLE = "That was not natural soil...",
		    ANNOUNCE_TOWNPORTALTELEPORT = "That felt... unnatural.",
		    ANNOUNCE_CANFIX = "\nI can mend this, like pruning a branch!",
		    ANNOUNCE_ACCOMPLISHMENT = "I’ve grown a little taller today!",
		    ANNOUNCE_ACCOMPLISHMENT_DONE = "If only the grove could see me now...",
		    ANNOUNCE_INSUFFICIENTFERTILIZER = "Still thirsty for nutrients?",
		    ANNOUNCE_TOOL_SLIP = "Slipped right through my leaves!",
		    ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Safe from the sky‑fire!",
		    ANNOUNCE_TOADESCAPING = "The toad’s hopping off...",
		    ANNOUNCE_TOADESCAPED = "It’s gone back to its pond.",

				ANNOUNCE_DAMP = "A gentle dew settles on me.",
				ANNOUNCE_WET = "My leaves are drinking deep.",
				ANNOUNCE_WETTER = "I’m becoming a walking rain‑soaked garden.",
				ANNOUNCE_SOAKED = "I’m more water than stem at this point.",

				ANNOUNCE_WASHED_ASHORE = "Washed up like driftwood, but still rooted in life.",

			    ANNOUNCE_DESPAWN = "The light calls me back to the great grove...",
				ANNOUNCE_BECOMEGHOST = "oOooOooo... a wandering spirit on the wind...",
				ANNOUNCE_GHOSTDRAIN = "My sap feels thin... my spirit’s slipping away...",
				ANNOUNCE_PETRIFED_TREES = "Did I just hear the forest cry out?",
				ANNOUNCE_KLAUS_ENRAGE = "That beast is beyond any gardener’s taming!",
				ANNOUNCE_KLAUS_UNCHAINED = "Its bindings have fallen like autumn leaves!",
				ANNOUNCE_KLAUS_CALLFORHELP = "It’s summoned more from the wilds!",

				ANNOUNCE_MOONALTAR_MINE =
				{
					GLASS_MED = "A shape stirs within the crystal bloom.",
					GLASS_LOW = "Just a few more careful chips...",
					GLASS_REVEAL = "You’re free to grow again!",
					IDOL_MED = "A form waits to sprout within.",
					IDOL_LOW = "Almost ready to emerge.",
					IDOL_REVEAL = "You’re free to grow again!",
					SEED_MED = "A seedling soul is trapped inside.",
					SEED_LOW = "Almost ready to germinate.",
					SEED_REVEAL = "You’re free to grow again!",
				},

			    --hallowed nights
			    ANNOUNCE_SPOOKED = "Did you see that shadow flit through the leaves?!",
				ANNOUNCE_BRAVERY_POTION = "The forest feels friendly again.",
				ANNOUNCE_MOONPOTION_FAILED = "Perhaps it needed more time to steep in moonlight...",

			    --lavaarena event
			    ANNOUNCE_REVIVING_CORPSE = "Let me help you take root again.",
			    ANNOUNCE_REVIVED_OTHER_CORPSE = "Fresh as spring growth!",
			    ANNOUNCE_REVIVED_FROM_CORPSE = "Sap’s flowing again, thank you.",

			    ANNOUNCE_FLARE_SEEN = "Who’s calling out across the horizon?",
			    ANNOUNCE_OCEAN_SILHOUETTE_INCOMING = "Something stirs beneath the waves...",
    --willow specific
	ANNOUNCE_LIGHTFIRE =
	{
		"only_used_by_willow",
